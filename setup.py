...
authors = [
    ('Josh Suresh', 'josh.suresh@gatesfoundation.org'),
    ('Ye Chen', 'ye.chen@gatesfoundation.org')
]

setuptools.setup(
    name="emod-genepi-archetypes",
    version="0.1.0",
    author=[author[0] for author in authors],
    author_email=[author[1] for author in authors],
    description="emod-genepi-archetypes package",
    install_requires=requirements,
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/jgsuresh/emod-genepi-archetypes",
    project_urls={
        "Bug Tracker": "https://github.com/jgsuresh/emod-genepi-archetypes/issues",
    },
    classifiers=[
        "Programming Language :: Python :: 3",
        "Operating System :: OS Independent"
    ],
    package_data={'run_sims': ['*/*.id', '*/*.json']},
